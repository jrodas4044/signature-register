  ...
  if (success) {
    return (
      <div className="relative flex flex-col justify-center items-center bg-gradient-to-br from-zinc-50 dark:from-zinc-950 via-zinc-50 dark:via-zinc-950 to-indigo-50/30 dark:to-indigo-950/20 px-6 min-h-screen overflow-hidden">
        ...
        <main className="z-10 relative space-y-6 bg-white/80 dark:bg-zinc-900/80 shadow-xl shadow-zinc-900/5 dark:shadow-zinc-950/50 backdrop-blur-xl p-8 border border-zinc-200/50 dark:border-zinc-800/50 rounded-2xl w-full max-w-md text-center animate-fadeIn">
          <div className="flex justify-center">
            <div className="flex justify-center items-center bg-gradient-to-br from-green-500 to-emerald-600 shadow-green-500/25 shadow-lg dark:shadow-green-500/10 rounded-full w-16 h-16">
              <svg
      ...
      <main className="z-10 relative space-y-8 bg-white/80 dark:bg-zinc-900/80 shadow-xl shadow-zinc-900/5 dark:shadow-zinc-950/50 backdrop-blur-xl p-8 border border-zinc-200/50 dark:border-zinc-800/50 rounded-2xl w-full max-w-md animate-fadeIn">
        ...
        <div className="space-y-3 text-center">
          ...
          <p className="text-zinc-600 dark:text-zinc-400 text-sm leading-relaxed">
            Únete al sistema de control de registro de firmas
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <p className="flex items-center gap-1.5 mt-1.5 text-zinc-500 dark:text-zinc-400 text-xs">
              <svg
                className="w-4 h-4"
                fill="none"
                viewBox="0 0 24 24"
